...
["Show talents and specialization in tooltips"] = "显示玩家天赋专精",
["Show player's GearScore in tooltips"] = "显示玩家GearScore信息",
["Show player's PawnScore in tooltips (may affect performance)"] = "显示玩家PawnScore信息 (可能影响性能)",
...
["Show GearScore in character frame"] = "显示 GearScore 信息",
["Average iLvl"] = "平均装等",
["Show Average Item Level in character frame"] = "显示玩家装备的平均物品等级",
["Lock Position"] = "锁定位置",
...
["Show Item GearScore"] = "显示GearScore",
["Show GearScore in item tooltips"] = "在物品的鼠标提示框中显示GS评分",
["Enhanced Tooltips"] = "技能提示",
["Disable In Combat"] = "战斗中隐藏",
["Disable gearscore & talents in combat"] = "战斗中隐藏 GS评分 & 天赋信息",
["Chat Class Colors"] = "聊天窗职业着色",
["Color names by class in chat windows"] = "玩家姓名在聊天窗口按职业着色",
["Instant Fade"] = "淡出",
["Fade out unit tooltips instantly"] = "淡出鼠标提示框",
["Custom Tooltip Position"] = "自定义鼠标提示框位置",
["Set a custom position for tooltips"] = "为鼠标提示框设置一个自定义位置",
["Tooltip Style"] = "鼠标提示框样式",
["FULL"] = "完整",
["Always FULL"] = "总是完全显示",
["COMPACT/FULL"] = "紧凑/完整",
...
["Mover"] = "定位器",
["Custom tooltip position enabled."] = "自定义鼠标提示框位置：启用",
["Custom tooltip position disabled."] = "自定义鼠标提示框位置：禁用",
["Custom position anchor set"] = "自定义位置锚点设置",
["Anchor to Mouse"] = "跟随鼠标",
["Anchor tooltips to mouse cursor"] = "鼠标提示框跟随鼠标的当前位置",
["Only in WorldFrame"] = "仅在户外",
["Anchor to mouse only in WorldFrame\nSkips raid / party frames"] = "仅在户外跟随鼠标，\n非Raid状态",
...
["TEXT_HELP_WELCOME"] = "by kebabstorm loaded(汉化 by 希曼来了). Safe travels!",
["TEXT_HELP_FIRST_LOGIN"] = "Type /tacotip to set up your preferences.",
["TEXT_HELP_MOVER_SHOWN"] = "鼠标提示定位器 已显示。拖动黄点来移动鼠标提示，点击中键来改变锚点，点击右键以保存",
["TEXT_HELP_MOVER_SAVED"] = "保存鼠标提示框位置，鼠标提示定位器被隐藏。输入'/tacotip custom '可再次移动",
